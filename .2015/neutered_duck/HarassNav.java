...
public class HarassNav extends Bot {
    ...
    private static boolean detectBugIntoEdge(Direction proposedMoveDir) {
        if (bugWallSide == WallSide.LEFT) {
            return rc.senseTerrainTile(here.add(proposedMoveDir.rotateLeft())) == TerrainTile.OFF_MAP;
        } else {
            return rc.senseTerrainTile(here.add(proposedMoveDir.rotateRight())) == TerrainTile.OFF_MAP;
        }
    }
...
//            Debug.indicateAppend("nav", 1, "detected bug into edge so reversing");
